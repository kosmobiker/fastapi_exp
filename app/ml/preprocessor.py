...
class Preprocessor():
    ...
    def __init__(self, data_path: str, save_path: str):
        ...
        if not self.data_path.exists():
            raise FileNotFoundError(f"The specified data path {self.data_path} does not exist.")
    ...
    def split_data(self, df: pd.DataFrame, target_col: str = "fraud_bool") -> (dict[str, pd.DataFrame]):
        """
...
if __name__ == "__main__":
    preprocessor = Preprocessor(data_path="data/raw/Base.csv", save_path="data/model_artifacts")
