...
from src.db.db_utils import CONNECTION_STRING
...
class TestTrainer:
    ...
    def test_run_trainer_and_get_results(self):
        # Given
        model_type = "logreg"
        model_name = "foo_bar"
        ...
        # When
        train_model(model_name=model_name, model_type=model_type, X_train=X_train, X_test=X_test, y_train=y_train, y_test=y_test)
